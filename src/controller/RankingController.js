...
exports.index = async (req, res) => {
    ...
    if (user != undefined) {
        res.render("ranking", { isLogin: true, user: user, isLogout: false, like_num: result, title: title});
    } else {
        res.render("ranking", { isLogin: false, isLogout: false, like_num: result, title: title});
    }
}